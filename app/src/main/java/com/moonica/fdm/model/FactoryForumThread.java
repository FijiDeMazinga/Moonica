...
public class FactoryForumThread {
    ...
    private FactoryForumThread (){
        ...
        thread2.setId(1);
        thread2.setTitolo("Richiesta spiegazione utilizzo del Lorem Ipsum");
        ...
        thread2.setAutore("Umbo");
        thread2.setNumRisposte(4);
        thread2.setCorso("IUM", "Interazione Uomo-Macchina");
        ...
        thread5.setAutore("Marco");
        thread5.setNumRisposte(0);
        thread5.setCorso("IUM", "Interazione Uomo-Macchina");
